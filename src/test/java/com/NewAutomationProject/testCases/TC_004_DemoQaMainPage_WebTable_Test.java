...
public class TC_004_DemoQaMainPage_WebTable_Test extends BaseClass3 {
	...
	@Test
	public void webTableValidationPage()
...
//		webT.getSpecificText();
//		log.info("got the specific text from the webtable");
