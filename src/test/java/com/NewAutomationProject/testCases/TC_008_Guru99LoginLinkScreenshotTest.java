...
import com.NewAutomationProject.pageObjects.Guru99LoginScreenshotsPage;
import com.NewAutomationProject.pageObjects.Guru99TableDemoPage;

import junit.framework.Assert;


public class TC_008_Guru99LoginLinkScreenshotTest extends BaseClass4{
	...
	public Guru99LoginScreenshotsPage s;
	
	@Test()
	public void LoginscreenshotCapture() throws IOException
	{
		...
		s=new Guru99LoginScreenshotsPage(driver);
	...
	//  Thread.sleep(4000);
	  ...
	  s.clickOnLoginOption();
	  log.info("successfully clicked on the login page option");
	  
	  s.screenshotOfPage();
	  log.info("successfully captured the screenshot of the login page");
