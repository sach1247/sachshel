...
public class TC_007_DemoQaMain_Alert_Window_Page extends BaseClass3 {
	...
	@Test
	public void Alert_Win_FrameValidation()
	{ 
		...
		log.info("successfully has been scrolled upto AWP");
