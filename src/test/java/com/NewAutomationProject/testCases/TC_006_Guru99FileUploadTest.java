...
public class TC_006_Guru99FileUploadTest extends BaseClass4 {
	...
	@Test(groups= {"sanity"}, dependsOnMethods="datePickerValidation", priority=6)
	public void fileUploadHandlingValidation() 
	{
